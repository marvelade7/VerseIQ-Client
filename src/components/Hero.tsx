    ...
    return (
        <div className="lg:py-20 md:py-15 py-12 lg:px-30 md:px-20 px-5">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-5 mt-8 sm:mt-10">
                <Link to='signup'><button className="w-full sm:w-auto bg-[#7C3AED] text-white text-base sm:text-lg px-4 py-2 rounded-md hover:bg-[#5a28c4] font-medium cursor-pointer duration-300">Start Quiz</button></Link>
                <Link to='signup' ><button className="w-full sm:w-auto bg-white text-[#7C3AED] text-base sm:text-lg px-4 py-2 rounded-md border border-[#7C3AED] hover:bg-[#e9e3f4] cursor-pointer font-medium duration-300">Register</button></Link>
            </div>
        </div>
    );
};
