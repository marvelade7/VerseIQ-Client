    ...
    return (
        <div className="sticky top-0 z-10 flex items-center justify-between gap-3 lg:px-20 sm:px-10 px-4 py-2 shadow-md bg-white text-black">
            ...
            <div className="flex items-center md:gap-5 gap-2 shrink-0">
                <button className="bg-white text-[#7C3AED] sm:px-4 px-3 sm:py-2 py-1.5 rounded-md border border-[#7C3AED] hover:bg-[#e9e3f4] cursor-pointer text-sm sm:text-base font-medium duration-300">Sign In</button>
